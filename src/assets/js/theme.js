      ...
      $(document).ready(function () {
        ...
        if (Swiper) {
          $('[data-toggle="swiper"]').each(function () {
            ...
            if (typeof swiperOpts === 'string') swiperOpts = JSON.parse(swiperOpts)
...
function getMarkerPopup(markerData) {
  ...
  var address = markerData.address
    ? '<p class="my-0 font-size-14"><i data-feather="map-pin" class="icon icon-xxs icon-dual mr-1"></i>' + markerData.address + '</p>'
    : ''
