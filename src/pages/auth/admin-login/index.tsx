                ...
                <Row className="g-0">
                  <Col md={5} className="shadow">
                    <div className="p-xl-5 p-3">
                      ...
                      <h6 className="h5 mb-0 mt-3">Admin Access</h6>
                      <p className="text-muted mt-1 mb-4">Enter your credentials to access the admin panel.</p>
                      <AdminLoginForm />
            ...
            <Row className="mt-3">
              <Col xs={12} className="text-center">
                <p className="text-muted">
                  ...
                  <Link to="/auth/admin-register" className="text-primary fw-semibold ms-1">
                    Register as Admin
                  </Link>
                </p>
              </Col>
